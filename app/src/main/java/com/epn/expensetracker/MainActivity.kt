...
import com.epn.expensetracker.ui.SplashScreen // Importamos la nueva pantalla
import com.epn.expensetracker.ui.theme.ExpenseTrackerTheme

class MainActivity : ComponentActivity() {

    // ... (Tus variables de horaPendiente, requestPermissionLauncher, etc. SIGUEN IGUAL) ...
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Inicialización de base de datos y ViewModel (SIGUE IGUAL)
        ...
        setContent {
            ExpenseTrackerTheme {
                Surface(
                    ...
                    if (showSplash) {
                        // 1. Mostramos el Splash
                        SplashScreen(
                            onAnimationFinished = {
                                // Cuando termina la animación, cambiamos el estado a false
                                showSplash = false
                            }
                        )
                    } else {
    ...
    // ... (Tu función manejarCambioRecordatorio SIGUE IGUAL) ...
