...
import androidx.compose.material3.OutlinedButton // IMPORTANTE: Se agregó este import
            ...
            if (gastos.isEmpty()) {
                ...
                gastos.forEach { gasto ->
                    GastoItem(
                        ...
                        onClick = { viewModel.prepararEdicion(gasto) } // Carga datos al hacer click
                    )
                }
            }
        }
...
/**
 * Formulario para ingresar o editar un gasto.
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun FormularioGasto(
    ...
    Card(
        ...
        Column(
            ...
            // Fila de Botones (Guardar y Cancelar)
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                // Botón Cancelar (Solo visible si hay algo escrito)
...
fun GastoItem(
    ...
    Card(
        modifier = Modifier
            ...
            .clickable { onClick() } // Permite seleccionar para editar
    ) {
        Row(
            modifier = Modifier
                .fillMaxWidth()
